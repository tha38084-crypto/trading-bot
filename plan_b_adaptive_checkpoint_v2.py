...
print("=" * 90)
print("PLAN B ADAPTIVE ENGINE v2.0 - AI-COPILOT CLOUD SYSTEM")
print("=" * 90)
...
print(f"  Modules  : E1-E6 + D1-D6 + A1-A8 = 19 Total")
print("=" * 90)
    ...
    for scan in scan_configs:
        for asset in WATCHLIST:
            ...
            if reg == "RANGE":
                ...
                if "H3D" in bar and "L3D" in bar and not pd.isna(bar["H3D"]) and not pd.isna(bar["L3D"]):
                    if close > ema200 and close > float(bar["H3D"]) and adx > ADX_TREND_TH: sigs.append("BUY")
                    if close < ema200 and close < float(bar["L3D"]) and adx > ADX_TREND_TH: sigs.append("SELL")
...
print("\n" + "="*90)
print("ADAPTIVE ENGINE v2.0 COMPLETE - 19 Modules Active!")
print("="*90 + "\n")
